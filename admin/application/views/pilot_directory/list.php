            ...
            <?php if($records->num_rows() > 0){ ?>
                <?php foreach($records->result() as $record){ ?>
                    <tr>
                        ...
                        <td><a class="edit" href="<?php echo site_url('/edit/'.$controller.'/'.$record->unique_id); ?>"><input type="image" src="<?php echo RIZ_SKIN; ?>images/icn_edit.png" title="Edit"></a><a class="delete" href="?delete=<?php echo $record->unique_id; ?>"><input type="image" src="<?php echo RIZ_SKIN; ?>images/icn_trash.png" title="Trash"></a></td>
                    </tr>
                <?php } ?>
            <?php }else{ ?>
                <tr>
