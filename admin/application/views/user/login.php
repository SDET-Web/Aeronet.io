<html>
	...
	<body>
		<div style="font-size:40px;text-align:center;margin-top:100px">Lazy-Eights Admin</div>
				<div style="text-align:center"><?php echo $success_msg.$error_msg; ?></div>

		<div id="container">
			<h1 id="mhead">Login</h1>
		<div id="body">
...
<form class="form" method="post" id="loginMemeber" novalidate="novalidate" >
					...
					<div class="controls">
						<input type="password" name="userPassword" id="userPassword" value="" class="input" placeholder="">
											</div>
				</div>
		...
		<div class="clear"></div>
	<p class="footer">Copyrights Lazy-Eights.com <?php echo date('Y'); ?></p>
</div>
