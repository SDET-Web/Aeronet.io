						...
						<div class="row">
							<?php foreach($records as $key){?>
								<?php if (wysiwyg_fields($key)):; ?>
									<div class="clearfix"></div>
								<?php endif; ?>
								<?php if(dont_show($key) && dont_show_certain($type,$key,'add')){ ?>
									<div class="<?php echo (wysiwyg_fields($key)?'col-md-11':'col-md-4'); ?>">
										<div class="form-group">
											...
											<div class="<?php echo (wysiwyg_fields($key)?'col-md-12':'col-sm-9'); ?>">
												<?php echo input_parser($key,$this->input->post($key)); ?>
											</div>
										</div>
									</div>
								<?php }?>
