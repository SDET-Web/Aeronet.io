...
function select_course_status($select = ''){
    $ar = array(
        ''=>'Select',
        'p'=>'Passed',
        'f'=>'Failed',
    ...
    return ($select != ''?$ar[strtolower($select)]:$ar);
}
...
function select_conn_type($select = ''){
    $ar = array(
        'p'=>'Friends',
        'd'=>'Following Department'
    );

    return ($select != ''?$ar[$select]:$ar);
}

function select_conn_status($select = ''){
    $ar = array(
        'a'=>'Accepted',
        'p'=>'Pending'
    );
...
function select_comm_status($select = ''){
    $ar = array(
        'a'=>'Accepted',
        'p'=>'Pending'
    );
