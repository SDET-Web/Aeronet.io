...
class linkedin
{
    ...
    function get_request_token()
    {
        ...
        //$args = array('scope' => 'r_basicprofile');
    ...
    function get_access_token($oauth_verifier)
    {
        ...
        //$request->set_parameter("oauth_token", substr($_SESSION['oauth_request_token'],4));
        $request->set_parameter("oauth_token", $_SESSION['oauth_request_token']);
        //echo "<br>__LINE__";
        $request->set_parameter("oauth_token_secret", $_SESSION['oauth_request_token_secret']);
        //echo "<br>line 4";
        $request->sign_request($this->method, $this->consumer, $this->token);
        //echo "<br>line 5";
        echo $request->to_url()."Nauman whatever ..... ";

        $response = $this->http($request->to_url());
        echo "<br><br><br>Zeshan here";
