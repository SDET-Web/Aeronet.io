...
class Googlemaps {
	...
	var $map_type					= "HYBRID";				// The default MapType. Values accepted are 'HYBRID', 'HYBRID', 'HYBRID' or 'TERRAIN'
	...
	var $zoom						= 11;						// The default zoom level of the map. If set to "auto" will autozoom/center to fit in all visible markers. If "auto", also overrides the $center parameter
	...
	function add_marker($params = array())
	{
		...
		$marker['icon'] = 'https://aeronet.io/skin/pic/call.png';									// The name or url of the icon to use for the marker
	...
	function create_map()
	{
		...
		if ($this->center!="auto") { $this->output_js_contents .= '
					center: myLatlng,'; }
		if (strtolower($this->map_type)=="street") { $map_type = "HYBRID"; }else{ $map_type = $this->map_type; }
		$this->output_js_contents .= '
