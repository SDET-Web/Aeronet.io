...
<div class="center wow fadeInDown"><p class="pt-30"></p><h2>Verify Your Phone</h2><br/> </div>      
    ...
    <?php if($msg != ''): ?>
    <div><div class="alert alert-danger fade in"> <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a><strong>Error!</strong><p><?php echo $msg; ?></p></div></div></div>
<?php endif; ?>
<section id="feature" >
    <div class="container" style="padding:10px; ">         
                ...
                if($pilot['user_type'] == 'P'){
                    ...
                    echo $pilot['certificates'][0]['type'];
                                    ...
                                    <label style="font-size:12px">Example: (xxx) xxx-xxxx</label>                    
                                    <!--
                        ...
                        <p class="pt-30"></p>           
                        <button id="btn" class="button-round" type="submit">Yes, Its My Phone</button> &nbsp; 
                        <a href="<?php echo site_url('register/pilot'); ?>"><button id="btn" class="button-round" type="button">No, this isn't me</button></a>
                        <p class="pt-30"></p>  
                                </div>
                            </div><!--/.media -->
