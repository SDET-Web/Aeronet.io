    ...
    <?php if(!isset($data["subscription"][0]) && $data["subscription"][0]["braintree_plan"] == ''&& $this->session->userdata("user_type") == "d"): ?>
     <div class="panel widget">
         <div class="panel-heading vd_bg-green">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-podcast"></i> </span> Please Subscribe to Source Top Tier Applicants.  </h3>
         </div>
       ...
       <div class="mgbt-xs-10"><a href="<?php echo site_url('flight-dispatch-board/create'); ?>">
              ...
              <h5>Subscribe to PREMIUM JOB POST below to Post Jobs with addendum, Applicant Tracking System
...
<?php if($data["subscription"][0]["braintree_plan"] == L8_PLAN_BASIC && $this->session->userdata("user_type") == "d"): ?>
       ...
       <div class="panel widget">
         <div class="panel-heading vd_bg-green">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-podcast"></i> </span>
           Thanks for Subscribing to Basic Membership  </h3>
         </div>
         <div class="panel-body">
...
and passive candidates (followers) can be manually moved to the ATS.  </h5>
             <br/>
                   ...
                   <a class="btn vd_btn vd_bg-green btn-lg" href="<?php echo site_url("flight-dispatch-board/create"); ?>">
 ...
 <?php if(!isset($data["subscription"][0]) || $data["subscription"][0]["braintree_plan"] == L8_PLAN_PREMIUM_CTS): ?>
     ...
     <?php if($this->session->userdata("user_type")  == "d"): ?>
      ...
      <div class="panel widget">
         <div class="panel-heading vd_bg-green">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-podcast"></i> </span> CANDIDATE TRACKING SOFTWARE  </h3>
         </div>
         <div class="panel-body">
            <div class="rows">
               ...
               <div class="col-md-8 col-sm-8 col-xs-12 pd-5">
                 <?php if($data["user_accepting_application"] == "y"): ?>
                   <h4 class="vd_green">Accepting Applications</h4>
                 <?php else: ?>
                 <h4 class="vd_green">Not Accepting Applications</h4>
                 <?php endif;?>
               </div>
    ...
    <?php endif; ?>
         ...
         <div class="col-md-12">
            <div class="panel widget">
               <div class="panel-heading vd_bg-blue">
                  <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-magic"></i> </span>Please Post Your Job Requirement Questions </h3>
               </div>
                     ...
                     <div id="wizard-3" class="form-wizard condensed">
                        ...
                        <div class="tab-content no-bd pd-25">
                           <div class="tab-pane" id="tab31">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-7 controls">
                                    <?php form_new_select_updated(select_aircraft_make_model_byUserID($this->session->userdata('user_id')), "", "aircraft", $this->input->post('aircraft'), true); ?>
                                 </div>
                              </div>
                              <div class="form-group">
                           ...
                           <div class="tab-pane" id="tab32">
                              <h4>(Based on the candidate position selected it will say 1 of the 4 below)<br/>
                                 let's find the right pilot to meet your needs.
                                 <br/>
                                 let's find the right maintenance technician to meet your needs.
                                 <br/>
                                 let's find the right flight attendant  to meet your needs.
                                 <br/>
                                 let's find the right dispatcher to meet your needs.
                              </h4>
                              <br/>
                              <template v-if="target == 'c' || target == 'o' || target == 'p'">
                                <h1> for Pilots ask the following questions..</h1>
                                <div class="form-group">
                              ...
                              <template v-else-if="target == 'a'">
                                <h1>Flight Attendant requirements:</h1>
                                <div class="form-group">
                           ...
                           <div class="form-actions wizard mgtp-20">
                              <div class="row mgbt-xs-0">
                                 ...
                                 <div class="col-xs-6 text-right"> <a class="btn vd_btn next" href="javascript:void(0);">Next <span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-right"></i></span></a> <button type="submit" class="btn vd_btn vd_bg-green finish"><span class="menu-icon"><i class="fa fa-fw fa-check"></i></span> Finish</button> </div>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <?php endif; ?>
      <!-- row -->
      <?php if(count($data["openings"]) > 0 && $data["user_accepting_application"] == "y"): ?>
      <?php foreach($data["openings"] as $opening): ?>
      <div class="panel widget"><br/><br/>
          <?php if($opening->target == "c" || $opening->target == "o" || $opening->target == "p"): ?>
          <div class="panel-heading vd_bg-green">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-plane"></i> </span>
               <?php echo $opening->title; ?>
            </h3>
         </div>
       <?php elseif($opening->target == "m"): ?>
         <div class="panel-heading vd_bg-facebook">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-toolbox"></i> </span>
       ...
       <?php elseif($opening->target == "a"): ?>
         <div class="panel-heading vd_bg-soft-green">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-user-tie"></i> </span>
               We are Hiring and Accepting Applications for Flight Attendant
            </h3>
         </div>
       <?php else: ?>
         <div class="panel-heading vd_bg-blue">
            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-headphones"></i> </span>
               <?php echo $opening->title; ?>
            </h3>
         </div>
       <?php endif; ?>
