...
<body>
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background-color:#474747;">
...
<div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <!--<li><a href="<?php //echo site_url('flight-dispatch-board'); ?>">Career</a></li>-->
