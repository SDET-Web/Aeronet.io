...
<?php $connections = $this->Model_connection->connections($this->session->userdata('user_id'),'p','p');
$connections = $this->Model_connection->invitations($this->session->userdata('user_id'),'p','d');?>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="vd_menu-search">
                                <form id="search-box" method="post" action="<?php echo site_url('search'); ?>">
                                    ...
                                    <div class="vd_menu-search-category"> <span data-action="click-trigger"> <span class="separator"></span> <span class="text">All</span> <span class="icon"> <i class="fa fa-caret-down"></i></span> </span>
                                                                   ...
                                                                   foreach($connections as $connection):
                                                                        ...
                                                                        <li> <a href="<?php echo site_url('pilot/'.$connection['id']); ?>">
                                                                            ...
                                                                            <div class="menu-text"> <?php echo get_data_value($connection,'fname'); ?> <?php echo get_data_value($connection,'lname'); ?>
                                                                                ...
                                                                                <?php $type=get_data_value($connection,'type');
                                                                                if( $type= 'd'):?>
                                                                                <button type="button" class="accept-followme btn vd_btn vd_bg-grey " object-id="<?php echo $connection['id']; ?>">
                                                                                <i class="fa fa-check-circle append-icon"></i>Follow me</button>       
                                                                                <?php else: ?>        
                                                ...
                                                <div class="child-menu">
                                                    ...
                                                    <div class="content-list content-menu">
                                                        <ul class="list-wrapper pd-lr-10">
                                                          ...
                                                          <!--  <li style="padding:5px;border-bottom:1px solid #eaeaea;"> <a href="<?php //echo site_url('setting'); ?>"> <div class="menu-icon"><i class=" fa fa-edit"></i></div> <div class="menu-text">Edit Profile</div> </a> </li> -->                                                        
                                                    <?php if($this->session->userdata('user_type') <> 'd'): ?>
<li style="padding:5px;border-bottom:1px solid #eaeaea;"> <a href="<?php echo site_url('my/network'); ?>"> <div class="menu-icon"><i class="fa fa-cogs"></i></div> <div class="menu-text"> Crew Connections </div> </a> </li>
<li style="padding:5px;border-bottom:1px solid #eaeaea;"> <a href="<?php echo site_url('pilot/'.$this->session->userdata('user_id').'/profile'); ?>"> <div class="menu-icon"><i class=" fa fa-building"></i></div> <div class="menu-text"> CV Builder </div> </a></li>                                                                                                                     
<li style="padding:5px;border-bottom:1px solid #eaeaea;"> <a href="<?php echo site_url('ResumeUpload'); ?>"> <div class="menu-icon"><i class="fa fa-file"></i></div> <div class="menu-text"> Resume </div> </a></li>                                                                                                                     
<li style="padding:5px;border-bottom:1px solid #eaeaea;"> <a href="<?php echo site_url('my/appliedjobs'); ?>"> <div class="menu-icon"><i class=" fa fa-server"></i></div>  <div class="menu-text">Application Tracking</div> </a> </li>
<li style="padding:5px;border-bottom:1px solid #eaeaea;">  <a href="<?php echo site_url('salary'); ?>"> <div class="menu-icon"><i class="fa fa-dollar-sign"></i></div> <div class="menu-text">Salary Navigator </div> </a> </li>
                                                    <?php endif; ?>
                                                            ...
                                                            <?php endif; ?>
                                                           <li style="padding:5px;border-bottom:1px solid #eaeaea;"><a href="<?php echo site_url('careers'); ?>"> <div class="menu-icon"><i class=" fa fa-search"></i></div> <div class="menu-text">Career</div> </a> </li>
    ...
    <footer id="footer">   
                 <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">                        
                     <p class="text-center">&copy; 2022 <a target="_blank" href="<?php echo site_url(''); ?>">AeroNet.io</a> <i> &nbsp; | &nbsp; &nbsp; &nbsp;<a href="<?php echo site_url('contact'); ?>"><i>Contact Us</i></a></i></p>
    ...
    <div class="vd_chat-menu col-md-4 col-sm-12 col-xs-12">
   ...
   <li class="one-big-icon mega-li mgr-10" >
      
       <a class="mega-link " href="<?php echo site_url('dashboard'); ?>" data-original-title="Home" data-toggle="tooltip" data-placement="top" >
       <span class="mega-icon">
    ...
    <li class="one-big-icon mega-li mgr-10">
       ...
       <a class="mega-link" href="<?php echo site_url('showflight'); ?>" data-original-title="Flight Post" data-toggle="tooltip" data-placement="top">
       <span class="mega-icon">
    ...
    <li class="one-big-icon mega-li mgr-10">
      <a class="mega-link" data-action="click-trigger" data-original-title="Connect" data-toggle="tooltip" data-placement="top">
                                                <span class="mega-icon"><i class="fa fa-users"></i></span>
                                                <?php if(count($connections) > 0): ?>
                                                    <span class="badge vd_bg-red"><?php echo count($connections) ;?></span>
                                                <?php endif; ?>
    ...
    <li class="one-big-icon mega-li mgr-10">
      <a class="mega-link" data-action="click-trigger" data-original-title="Messages" data-toggle="tooltip" data-placement="top">
                                                <span class="mega-icon"><i class="fa fa-envelope"></i></span>
                                                <?php if(count($conversations_recieved) > 0): ?>
                                                    <span class="badge vd_bg-red"><?php echo count($conversations_recieved); ?></span>
                                                <?php endif; ?>
           	...
           	<div  data-rel="scroll">
                                                            <ul class="list-wrapper pd-lr-10">
                                                                <?php if(count($conversations_recieved) > 0): ?>
                                                                    <?php foreach($conversations_recieved as $key=>$convo): $convo = (array)$convo[count($convo) - 1]; ?>
                                                                        <li style="cursor:pointer;" onclick="window.location='<?php echo site_url('conversation/'.$key); ?>'">
                                                                            <div class="menu-icon"><img  src="<?php echo get_user_pic_url($convo['user_image'],"p"); ?>"></div>
                                                                            <div class="menu-text"> <?php echo $convo['mess_text']; ?>
                                                                                <div class="menu-info">
                                                                                    <span class="menu-date"><?php echo date('d/m/Y',$convo['mess_created']); ?></span>
                                                                            <span class="menu-action">
    ...
    <li class="one-big-icon mega-li mgr-10">
      <a class="mega-link" data-action="click-trigger" data-original-title="Notifications" data-toggle="tooltip" data-placement="top">
                                                <span class="mega-icon"><i class="fa fa-globe"></i></span>
                                                <?php if(count($notifications) > 0): ?>
                                                    <span class="badge vd_bg-red noti-count"><?php echo count($notifications); ?></span>
                                                <?php endif; ?>
    ...
    <li class="profile mega-li mgr-10">
        <a class="mega-link pd-10" href="#"  data-action="click-trigger" data-original-title="Menu" data-toggle="tooltip" data-placement="top">
            <span class="menu-name" style="font-size:26px;">
...
<div id="demo-message" class="hidden">
    <li > <a href="#">
            <div class="menu-icon"><img src="<?php echo get_user_pic_url($this->session->userdata('user_image'),$this->session->userdata('user_type')); ?>"></div>
