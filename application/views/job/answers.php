<div class="row" style="margin-top:50px;padding:30px;">
    <div class="col-md-12 col-sm-12"><?php  $this->load->view('job/questions', array('addendum' => $applicant->addendum));?></div></div>

<!--<div>
    <h3>Cover Letter</h3>
    <pre>
        <?php echo $addendum->cover_letter; ?>
    </pre>
</div>
<div>
    <h3>Addendum</h3>
...
<div class="form-level">
    <h4 class="vd_blue">Criminal Background - Self Disclosure</h4>
</div>
<div>
...
<div class="form-level">
    <h4 class="vd_blue">Department of Transportation - Self Disclosure:</h4>
</div>
<div>
...
<div class="form-level">
    <h4 class="vd_blue">Driving History - Self Disclosure:</h4>
</div>
<div>
...
<div class="form-level">
    <p><b>Please explain Including the nature:</b></p>
...
<div class="form-level">
    <h4 class="vd_blue">FAA Record and Training Events - Self Disclosure</h4>
</div>
<div>
