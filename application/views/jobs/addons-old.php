   ...
   <div class="row">
            ...
            <div class="panel widget vd_summary-panel">
               ...
               <div class="panel-body-list">
                  ...
                  <div style="" class="closing text-right pd-15">
                     ...
                     <br/><?php if($amount != 0): ?>You will be charged after 7 Days Trial<?php endif; ?><br/><br/>
                     <?php if($amount != 0): ?>
      ...
      <div class="col-md-8 col-xs-12">
          <div style="text-align:center">
           ...
           <?php } else { ?>
             <br/><br/>
               <h3 class="vd_blue"> Thanks for Subscribing to Complete Applicant Tracking System </h3>
         ...
         <br/><br/>
             ...
             <?php if($subscription->braintree_plan == L8_PLAN_PREMIUM_CTS): ?>
              ...
              <!-- <div class="mgbt-xs-10"><a href="<?php //echo site_url('flight-dispatch-board/create'); ?>">
               ...
               <div class="mgbt-xs-10"><a href="<?php echo site_url('flight-dispatch-board/cancel'); ?>">
                <button type="button" class="btn vd_btn vd_bg-red btn-block"><span class="append-icon">
                <i class="fa fa-times"></i></span> Cancel ATS Recurring Subscription </button></a>
               </div>
               <?php endif; ?>
           <?php } ?>
         </div>
