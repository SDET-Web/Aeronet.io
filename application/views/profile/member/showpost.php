 ...
 <span class="menu-info"><span class="menu-date"> <?php echo get_data_value($item,'empl_monthfromjob').' '.get_data_value($item,'empl_yearfromjob'); ?> ~ <?php echo get_data_value($item,'empl_monthtojob').' '.get_data_value($item,'empl_yeartojob'); ?>
        ...
        <span class="menu-date"> : <?php echo get_data_value($item,'time_val'); ?> </span> </span>  </li>
          ...
          <?php if(count($data['aircraft'])): ?>
                                    <?php foreach($data['aircraft'] as $key=>$item): ?>                                        <div class="row">
                          ...
                          <div class="panel panel-default">
                        <div class="panel-heading vd_bg-linkedin">
                          <center><h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse7">Flight Album </a> </h4></center>
                        </div>
                ...
                <ul id="rig">
                 <?php foreach($data['photos'] as $key=>$item): $item = (array)$item;if($key > 15){continue;} ?>
                     <?php if($item['photo_title'] <> 'Profile Photo'): ?> <li style='padding-right:2px;'>                    
