                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs widget">
                          <li class="active" style="width:50%;" > <a href="#flight-tab" data-toggle="tab"> <span class="menu-icon"><i class="fas fa-plane"></i></span> Flight Memory <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                          <li style="width:48%;" > <a href="#main-tab" data-toggle="tab"> <span class="menu-icon"><i class="fa fa-comments"></i></span> Hangar Memory  <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
...
input[type="date"] {
  ...
  border:0px solid;border-bottom: 2px solid steelblue;
  font-weight:bold;
  color:steelblue;
...
input[type="date"]:hover::-webkit-calendar-picker-indicator:hover { opacity:0.15; }
    ...
    <div class="controls">
    <input type="date" 
    placeholder="Choose Flight Date" name="fdate" id="fdate" class="datepicker" value="<?php echo date("Y-m-d"); ?>" />
                                            </div>
                                        </div>
