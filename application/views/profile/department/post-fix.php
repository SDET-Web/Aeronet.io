                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs widget">
                            ...
                            <li style="width:48%;" > <a href="#main-tab" data-toggle="tab"> <span class="menu-icon"><i class="fa fa-comments"></i></span> <?php if($this->session->userdata("user_type") == "d"):?>Internal Job Posting<?else:?>Share an update <?endif;?> <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                              ...
                              <form method="post" enctype="multipart/form-data" onsubmit="setItUp();">
                                  ...
                                  <div class="vd_textarea-menu vd_bg-dark-green vd_bd-green" >
                                      <ul class="nav nav-pills ">
                                          ...
                                          <li class="pull-right">
                                              <button type="submit" style="background:transparent;color:#fff;border:0 solid;padding:6px;" data-toggle="tab-post" href="javascript:void(0);" style="border-left:1px solid rgba(255,255,255,.3)">
                                                <span class="menu-icon">
...
<br/><br/><script type="text/javascript">
    ...
    sessionStorage.setItem('key', myvar);
                    ...
                    <ul class="vd_timeline post-list"  zeroMessage="No Posts" barShowFuntion="" isBlocked="false" page="0" sort=""  barTitle="Favorite Articles" countContainer="#count-favorite-article" searchTerm="" url="<?php echo site_url('post/'.$data['user_id']); ?>" ></ul>
